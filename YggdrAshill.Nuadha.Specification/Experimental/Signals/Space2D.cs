    ...
    public static class Space2D
    {
            ...
            IEquatable<Direction>
        {
            ...
            public static bool operator ==(Direction left, Direction right)
            {
                ...
                var difference = MathF.Abs(Length - dotted);
            ...
            IEquatable<Rotation>
        {
            ...
            {
                var horizontal = MathF.Cos((float)radian);

                var vertical = MathF.Sin((float)radian);
            ...
            {
                var radian = MathF.Acos(rotation.Horizontal) * MathF.Sign(rotation.Vertical);
