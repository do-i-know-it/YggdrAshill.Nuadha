...
//            Assert.Throws<ArgumentNullException>(() =>
//            {
//                var consumption = DetectTo.Consume(default(INotification<Signal>), consumeSignal);
//            });
//        }
...
//            Assert.Throws<ArgumentNullException>(() =>
//            {
//                var production = DetectTo.Produce(propagateSignal, default(INotification<Signal>));
//            });
