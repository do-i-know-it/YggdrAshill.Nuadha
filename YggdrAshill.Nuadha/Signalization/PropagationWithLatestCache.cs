...
namespace YggdrAshill.Nuadha
{
    ...
    /// </typeparam>
    public sealed class PropagationWithLatestCache<TSignal> :
        IPropagation<TSignal>
        where TSignal : ISignal
    {
        private readonly PropagationWithoutCache<TSignal> propagation = new PropagationWithoutCache<TSignal>();
        ...
        /// </param>
        public PropagationWithLatestCache(TSignal initial)
        {
            cached = initial;
        }
